<?php
	...
	$queryHK=mysql_query('SELECT isi_hasil FROM hasil_kerjasama');
	$rowHK=mysql_fetch_array($queryHK);
?>
									...
									<div id="content">
										...
										<!-- Content -->
											...
											<article>
												...
												<span class="image image-full"><img src="images/pof1.jpg" alt="" /></span>
												<?php echo $rowHK['isi_hasil'];
