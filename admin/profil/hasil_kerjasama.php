...
$queryPend=mysql_query('SELECT isi_hasil FROM hasil_kerjasama');
?>
<div id="three-column">
	...
	<div id="page">
		<div class="post">
			<h2 class="title">Hasil Kerjasama Update</h2>
			<form action="hasil_kerjasama_proses.php" method="post">
				<table>
				<?php
				while($row=mysql_fetch_array($queryPend)){
				?>
					<tr>
						<td><label for="isi_kerjasama" id="admin-label">Hasil kerjasama</label></td>
					</tr>
					<tr>
						<td>
