<?php
	...
	$queryLokasi=mysql_query('SELECT * FROM profil_lokasi WHERE id_lokasi=1');
?>
								...
								<div class="8u mobileUI-main-content">
									<div id="content">
										...
										<!-- Content -->
											...
											<article>
												<header class="major">
													<h2>Lokasi PT. Bimarenda Putra</h2>
												</header>
												<span class="image image-full"><iframe width="800" height="300" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps/ms?msa=0&amp;msid=212563399756620414269.0004d84682fe3dc27cf71&amp;ie=UTF8&amp;ll=-7.815155,110.376345&amp;spn=0,0&amp;t=m&amp;output=embed"></iframe><br /><small>View <a href="https://maps.google.com/maps/ms?msa=0&amp;msid=212563399756620414269.0004d84682fe3dc27cf71&amp;ie=UTF8&amp;ll=-7.815155,110.376345&amp;spn=0,0&amp;t=m&amp;source=embed" style="color:#0000FF;text-align:left">PT. Bimarendra Putra</a> in a larger map</small></span>
												<?php
												while($rowLokasi=mysql_fetch_array($queryLokasi)){
													echo $rowLokasi['lokasi'];
												}
												?>	
											</article>
