											...
											<article>
												<form action="saran_proses.php" method="post" >
													<table>
														<tr>
															<td>Nama</td>
															<td><input type="text" size="12" name="nama_saran"/></td>
														</tr>
														<tr>
															<td>Email</td>
															<td><input type="text" name="email_saran" size="25" /></td>
														</tr>
														<tr>
															<td>Saran</td>
															<td><textarea name="isi_saran" rows="15" cols="100" style="width: 70%"></textarea>
															</td>
														</tr>
															<td colspan="3">
