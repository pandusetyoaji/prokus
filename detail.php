<?php
	...
	$queryBerita=mysql_query("SELECT * FROM home_news WHERE id_news='$id_news'");
	$row=mysql_fetch_array($queryBerita);
?>
								...
								<div class="12u mobileUI-main-content">
									<div id="content">
										...
										<!-- Content -->
											...
											<article>
												<header class="major">
													<span class="byline"><?php echo $row['tanggal_news'];?></span>
												</header>
												<h3><?php echo $row['judul_news'];?></h3>
